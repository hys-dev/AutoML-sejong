...
exp_key = os.environ.get('EXP_KEY').strip()
...
def nas_search_experiment(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if utils.is_main_process():
            nni.report_intermediate_result(round(test_stats['f1_score'], 3))
    ...
    if utils.is_main_process():
        nni.report_final_result(max_metric)
...
if __name__ == '__main__':
    ...
    def load_cache(filename):
        data = utils.load_from_json(filename)
        return data
